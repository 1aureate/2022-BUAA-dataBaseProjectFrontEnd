    ...
    >
        <el-dialog :visible.sync="dialogFormVisible" :append-to-body="true" title="购买详情">
          <el-form :model="form" :rules="rules">
            ...
            <el-form-item label="位置" :label-width="formLabelWidth" prop="tpos">
              <el-select v-model="form.tpos" clearable placeholder="请选择">
                <el-option
          ...
          <template #footer>
            <span class="dialog-footer">
              ...
              <el-button type="primary" :disabled="!formal" @click="handleConfirmPurchase()"
                >确认</el-button
              >
            </span>
          </template>
        ...
        <template #default="props">
            ...
            <div>
              <div style="width:200px;height:200px;float:left;margin-right:120px">
                <el-skeleton
              ...
              <div style="width:400px;height:200px;float:left;margin-right:20px">
        ...
        <el-table-column label="位置" prop="ppos" />
...
export default {
  data() {
    return {
      ...
      rules: {
          ...
          tpos: [{ required: true, message: '请选择位置', trigger: 'blur'}],
  ...
  methods: {
    ...
    ,
  getCoach() {
    this.$axios.post('http://127.0.0.1:5000/test/data/getFreePlayers', 
            {
    ...
    ,
    confirmPurchase() {
      this.$axios.post('http://127.0.0.1:5000/test/action/gmHirePlayer', 
            this.form
            ).then(
                res => {
                    console.log(res);
